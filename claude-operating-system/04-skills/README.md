...
| # | الملف | الغرض الموجز | مخرج الحكم |
|---|---|---|---|
| 1 | `executive-brief-skill.md` | تلخيص تنفيذي لحدث/تقرير لصانع قرار | لا يوجد PASS/FIX/FAIL — يوجد Evidence Status |
| 2 | `competitor-trust-audit-skill.md` | تدقيق مصداقية منافس أو ادعاء تسويقي | TRUST / VERIFY / AVOID |
| 3 | `cash-recovery-decision-skill.md` | تحديد مسار تحصيل مالي (ESTARED/NCGR) | COLLECT / RECONCILE / ESCALATE / HOLD / WRITE-OFF REVIEW |
| 4 | `product-governance-review-skill.md` | مراجعة اتساق منتج مع حوكمة NEXGEGL | PASS / FIX / FAIL |
| 5 | `claude-code-pr-review-skill.md` | مراجعة Pull Request قبل الدمج | MERGE READY / FIX BEFORE MERGE / BLOCK MERGE |
| 6 | `board-response-skill.md` | صياغة رد على مستوى مجلس إدارة | لا يوجد PASS/FIX/FAIL — نص جاهز فقط |
| 7 | `client-discovery-skill.md` | تحويل طلب عميل خام إلى نطاق مشروع منظَّم | لا يوجد PASS/FIX/FAIL — يوجد Readiness Check |
| 8 | `pricing-scope-skill.md` | بناء نطاق وتسعير عرض تجاري | لا يوجد PASS/FIX/FAIL — يوجد Margin Risk Flag |
| 9 | `evidence-pack-builder-skill.md` | تجميع حزمة أدلة قبل أي قرار | لا يوجد PASS/FIX/FAIL — يوجد Decision Readiness |
