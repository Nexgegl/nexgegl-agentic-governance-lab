...
export default function PermissionsPage() {
  ...
  return (
    <div className="space-y-6">
      <Topbar
        titleAr="خريطة الصلاحيات"
        titleEn="Agent Permission Map"
      ...
      <section className="overflow-x-auto rounded-xl border border-navy-100 bg-white shadow-card">
        <table className="w-full min-w-[1200px] text-sm">
          <thead className="bg-navy-50 text-xs text-navy-500">
            <tr>
              <th className="sticky start-0 z-10 bg-navy-50 px-4 py-3 text-start font-medium">الوكيل / حالة الاستخدام</th>
